...
public class ConfigGenerator extends BaseGenerator{
	...
	private static void generateJDBCConfig(){
		...
		FileUtils.write(content, PropertiesUtils.getLocation()+"/src/main/resources/jdbc.properties");
	}
	private static void generateFile(String content, String template){
		...
		FileUtils.write(content, PropertiesUtils.getLocation()+"/src/main/resources/" + name + ".xml");
	}
}
